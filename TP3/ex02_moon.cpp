...
int main(int argc, char *argv[])
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        *********************************/
        ...
        auto a_mv_matrix = glm::rotate(mv_matrix, glimac::getTime(), glm::vec3(0, 1, 0)); // Translation * Rotation
        a_mv_matrix = glm::translate(a_mv_matrix, glm::vec3(-2, 0, 0)); // Translation * Rotation * Translation
